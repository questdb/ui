...
const FilledSparkle = ({ gradientId }: { gradientId: string }) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
      ...
      <defs>
        ...
        >
          <stop stopColor={theme.color.aiGradientStart} />
          <stop offset="1" stopColor={theme.color.aiGradientEnd} />
        </linearGradient>
      </defs>
    </svg>
  )
...
const HollowSparkle = () => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" fill="none">
      <path
        fill={theme.color.aiGradientStart}
...
export const AISparkle = ({
  ...
  const gradientId = useMemo(
    () => `aiSparkleGradient-${++gradientIdCounter}`,
    [],
  )
  ...
  return (
    <Wrapper $size={size} $inverted={inverted} className={className}>
      {variant === "filled" ? (
        <FilledSparkle gradientId={gradientId} />
      ) : (
        <HollowSparkle />
      )}
    </Wrapper>
