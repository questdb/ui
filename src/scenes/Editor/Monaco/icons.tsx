    ...
    case "aiSparkleFilled": {
      ...
      <defs>
          <linearGradient id="${gradientId}" x1="12.37" x2="12.37" y1=".75" y2="22.5" gradientUnits="userSpaceOnUse">
            <stop stop-color="${getThemeColor("aiPinkStart")}"/>
            <stop offset="1" stop-color="${getThemeColor("aiPinkEnd")}"/>
          </linearGradient>
        </defs>
