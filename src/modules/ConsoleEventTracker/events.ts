export enum ConsoleEvent {
  ...
  NOTEBOOK_VARIABLE_SELECT = "notebook.variable_select",
  NOTEBOOK_VARIABLE_OPTIONS_FETCH = "notebook.variable_options_fetch",
  NOTEBOOK_TIME_RANGE_APPLY = "notebook.time_range_apply",
  NOTEBOOK_TIME_RANGE_CLEAR = "notebook.time_range_clear",
  NOTEBOOK_CELL_TIME_RANGE_SET = "notebook.cell_time_range_set",
  NOTEBOOK_CELL_TIME_RANGE_CLEAR = "notebook.cell_time_range_clear",
  ...
  MCP_SET_CELL_TIME_RANGE = "mcp.set_cell_time_range",
